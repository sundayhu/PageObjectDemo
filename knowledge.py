...
class Knowledge:
        ...
        for data in prams_list:
            ...
            if s=='projectid':
                ...
                if data.split('=')[1] in thelist:
                    ...
                    ss='1'
                element = self.driver.find_element_by_id("projectid")
                sel = Select(element)
                sel.select_by_value(ss)
            if s=='type':
                thelist=['Technology','Business','Management','CustomerEvent']
                if data.split('=')[1] in thelist:
                    ss=data.split('=')[1]
                else:
                    ss='Technology'
    ...
    def search(self,prams_list):
        self.driver.find_element_by_id('knowledgeid').clear()
        ...
        for data in prams_list:
            ...
            if s == 'knowledgeid':
                ...
                self.driver.find_element_by_id('knowledgeid').send_keys(data.split('=')[1])
            if s == 'creator':
